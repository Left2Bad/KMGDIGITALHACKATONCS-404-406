@{
    lab_expired_user = @('IRA-ACCOUNT-002')
    lab_pne_user = @('IRA-PASSWORD-001')
    svc_sql = @('IRA-PASSWORD-001', 'IRA-SERVICE-001')
    lab_direct_admin = @('IRA-PRIV-001')
    lab_nested_admin = @('IRA-PRIV-002')
